...
const createMessage = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const Message = yield (0, messages_service_1.createMessageInDb)(req.body);
...
const getMessages = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const Messages = yield (0, messages_service_1.getMessagesInDb)();
        res.json(Messages);
    }
    catch (error) {
...
const getMessageById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const Message = yield (0, messages_service_1.getMessageByIdInDb)(req.params.id);
        if (!Message) {
...
const updateMessage = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const Message = yield (0, messages_service_1.updateMessageInDb)(req.params.id, req.body);
        if (!Message) {
            res.status(404).json({ message: "User flow not found" });
            return;
        }
...
const deleteMessage = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const Message = yield (0, messages_service_1.deleteMessageInDb)(req.params.id);
        if (!Message) {
            res.status(404).json({ message: "User flow not found" });
            return;
        }

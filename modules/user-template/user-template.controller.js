...
const user_template_service_1 = require("./user-template.service");
// Create a new UserFlow
const createUserFlow = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        console.log(req, 'ppppppppppppp');
        const userFlow = yield (0, user_template_service_1.createUserFlowService)(req.body);
...
const getUserFlows = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userFlows = yield (0, user_template_service_1.getUserFlowsService)();
        res.json(userFlows);
    }
    catch (error) {
...
const getUserFlowById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userFlow = yield (0, user_template_service_1.getUserFlowByIdService)(req.params.id);
        if (!userFlow) {
...
const updateUserFlow = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userFlow = yield (0, user_template_service_1.updateUserFlowService)(req.params.id, req.body);
        if (!userFlow) {
            res.status(404).json({ message: "User flow not found" });
            return;
        }
...
const deleteUserFlow = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userFlow = yield (0, user_template_service_1.deleteUserFlowService)(req.params.id);
        if (!userFlow) {
            res.status(404).json({ message: "User flow not found" });
            return;
        }
